...
public final class OctoPrintJob implements Jsonable, JSONLoader {
	...
	public String getName(){
		...
		if(m_job.containsKey("file"))
		{
			...
			{
				result = file.getString(new JsonKey() {
					@Override
	...
	public Long getEstimatedPrintTime(){
		...
		{
			result =  m_job.getLong(new JsonKey() {
				@Override
	...
	public final class JobProgress implements Jsonable, JSONLoader {
		...
		public Double percentComplete(){
			return m_json.getDouble(new JsonKey() {
				@Override
				public String getKey() { return "completion"; }
		...
		public Long elapsedTime(){
			return m_json.getLong(new JsonKey() {
				@Override
				public String getKey() { return "printTime"; }
		...
		public Long timeRemaining(){
			return m_json.getLong(new JsonKey() {
				@Override
				public String getKey() { return "printTimeLeft"; }
	...
	public static final class FilamentDetails implements Jsonable, JSONLoader {
		...
		public Long length(){
			try {
				return this.m_json.getLong(new JsonKey() {
					@Override
					public String getKey() { return "length"; }
		...
		public Double volume(){
			try {
				return this.m_json.getDouble(new JsonKey() {
					@Override
					public String getKey() { return "volume"; }
