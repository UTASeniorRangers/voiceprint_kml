...
public class JSONUtils {
	...
	public static <V> Map<String,V> loadMap(JsonObject jMap, Class<V> value) throws JsonException {
	...
	@SuppressWarnings("unchecked")
	public static <T> List<T> loadList(JsonArray jArray, Class<T> type) throws JsonException {
	...
	public static <T> T createObject(String json, String type) throws JsonException {
